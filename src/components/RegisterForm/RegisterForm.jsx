  ...
  return (
    <div className={css.RegisterWrapper}>
      <form className={css.RegisterForm} onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className={css.RegisterContainer}>
          <label className={css.RegisterLabel}>
            ...
            <div className={css.RegisterPosition}>
              <input
                className={`${css.RegisterInput} ${errors.email ? css.formInputError : ""}`}
                type="email"
                {...register("email")}
                autoComplete="email"
          ...
          <label className={css.RegisterLabel}>
            ...
            <div className={css.RegisterPosition}>
              <input
                className={`${css.RegisterInput} ${errors.password ? css.formInputError : ""}`}
                type={showPassword ? "text" : "password"}
                {...register("password")}
                autoComplete="new-password"
                placeholder="Enter your password"
              />
              <svg width="20" height="20" className={css.singUpIcon} onClick={onShowPassword}>
                <use href={`${sprite}#icon-${showPassword ? "eye" : "eye-off"}`}></use>
              </svg>
              <div className={css.errorMessageWrapper}>
          ...
          <label className={css.RegisterLabel}>
            ...
            <div className={css.RegisterPosition}>
              ...
              />
              <svg width="20" height="20" className={css.singUpIcon} onClick={onShowRepeatPassword}>
                <use href={`${sprite}#icon-${showRepeatPassword ? "eye" : "eye-off"}`}></use>
              </svg>
              <div className={css.errorMessageWrapper}>
        ...
        <button disabled={!isDirty || !isValid} className={css.RegisterBtn} type="submit">
          Sign Up
        </button>
